...
# Get 10 transactions into the new epoch.
	${BIN_PATH}/db-backup one-shot backup --backup-service-address ${URL}:6186 transaction --num_transactions 10 --start-version ${EPOCH_SNAPSHOT_VERSION} local-fs --dir ${ARCHIVE_PATH}/${EPOCH}
